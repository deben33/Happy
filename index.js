...
client.on('guildMemberRemove', member => {
    member.guild.channels.cache.get(config.greeting.channelend).send(`**${member.user.tag}** a quitté le serveur...! 😢 https://tenor.com/view/mandalorian-baby-yoda-baby-yoda-wave-magic-hand-thing-baby-yoda-magic-hand-thing-gif-15921838 `)
})
